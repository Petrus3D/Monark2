...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 30 Juillet 2016 à 13:01
...
--
-- Vider la table avant d'insérer `alert`
--
...
--
-- Vider la table avant d'insérer `ban`
--
...
--
-- Vider la table avant d'insérer `building`
--
...
--
-- Vider la table avant d'insérer `buy`
--
...
--
-- Vider la table avant d'insérer `chat`
--
...
--
-- Vider la table avant d'insérer `chat_read`
--
...
--
-- Vider la table avant d'insérer `continent`
--
...
--
-- Vider la table avant d'insérer `difficulty`
--
...
--
-- Vider la table avant d'insérer `fight`
--
...
INSERT INTO `fight` (`fight_id`, `fight_game_id`, `fight_atk_user_id`, `fight_def_user_id`, `fight_atk_land_id`, `fight_def_land_id`, `fight_atk_lost_unit`, `fight_def_lost_unit`, `fight_atk_units`, `fight_def_units`, `fight_atk_nb_units`, `fight_def_nb_units`, `fight_thimble_atk`, `fight_thimble_def`, `fight_time`, `fight_turn_id`, `fight_conquest`) VALUES
(1, 20, 268, 0, 16, 40, 3, 3, '/5/3/2', '/3/3/2', 5, 3, '/5;2;1;1;/5;1;1;/4;3;', '/5;5;/4;4;/3;1;', 1469838632, 112, 1),
(2, 20, 268, 0, 40, 41, 1, 3, '/5/5/4', '/3/1/1', 5, 3, '/6;6;2;/5;3;2;/5;2;2;', '/3;3;/6;/1;', 1469838764, 112, 1),
(3, 20, 268, 0, 40, 42, 5, 1, '/5/3/1/1', '/3/3/3/2', 5, 3, '/3;2;2;/3;1;1;/4;/4;', '/5;2;/5;5;/3;1;/6;5;', 1469838788, 112, 0),
(4, 20, 268, 0, 41, 39, 3, 1, '/3/2', '/3/2', 3, 3, '/6;5;1;/4;3;', '/6;3;/6;4;', 1469838904, 112, 0),
(5, 20, 268, 0, 40, 42, 2, 1, '/5/4/3', '/1/1/1', 5, 1, '/5;3;3;/3;3;2;/6;6;3;', '/5;/3;/5;', 1469839037, 112, 1),
(6, 20, 268, 0, 41, 39, 0, 1, '/9', '/1', 9, 1, '/6;4;4;', '/5;', 1469839045, 112, 1),
(7, 24, 269, 0, 40, 41, 0, 3, '/5/5', '/3/1', 5, 3, '/6;6;2;/6;4;1;', '/2;1;/3;', 1469871607, 115, 1),
(8, 24, 64, 0, 16, 10, 4, 3, '/7/7/6/5/4/3', '/3/1/1/1/1/1', 7, 3, '/6;6;3;/6;6;5;/6;3;2;/2;2;1;/6;5;2;/4;4;4;', '/4;1;/6;/6;/3;/6;/3;', 1469871664, 116, 1),
(9, 24, 269, 0, 40, 42, 1, 3, '/5/5/4', '/3/1/1', 5, 3, '/6;5;3;/5;5;4;/5;2;1;', '/4;3;/6;/4;', 1469871723, 117, 1),
(10, 24, 64, 0, 16, 9, 1, 3, '/4/4/3', '/3/1/1', 4, 3, '/6;4;3;/4;3;2;/6;5;3;', '/5;1;/5;/2;', 1469871770, 118, 1),
(11, 24, 269, 0, 42, 39, 7, 1, '/7/6/4/2', '/3/2/2/2', 7, 3, '/3;3;1;/5;4;1;/5;3;1;/5;3;', '/4;2;/6;4;/6;6;/5;3;', 1469871826, 119, 0),
(12, 24, 64, 0, 10, 14, 0, 3, '/4/4', '/3/1', 4, 3, '/5;3;2;/6;2;1;', '/3;1;/3;', 1469871909, 120, 1),
(13, 24, 269, 64, 40, 16, 2, 4, '/8/6', '/4/3', 8, 4, '/5;4;3;/5;4;4;', '/6;4;1;/3;1;1;', 1469872001, 121, 1),
(14, 24, 64, 269, 10, 16, 7, 3, '/7/4/4/1', '/6/6/3/3', 7, 6, '/4;3;2;/6;5;3;/4;3;1;/6;', '/4;3;2;/5;3;2;/6;6;1;/6;1;1;', 1469872051, 122, 0),
(15, 24, 269, 0, 42, 39, 0, 1, '/5', '/1', 5, 1, '/6;6;5;', '/5;', 1469872135, 123, 1),
(16, 24, 64, 269, 10, 16, 0, 1, '/4', '/1', 4, 1, '/6;5;3;', '/1;', 1469872184, 124, 1),
(17, 24, 64, 0, 14, 35, 3, 0, '/3/1', '/3/3', 3, 3, '/6;5;1;/1;', '/6;5;/6;2;', 1469872233, 124, 0),
(18, 24, 269, 0, 42, 43, 0, 3, '/5/5', '/3/1', 5, 3, '/6;5;2;/4;3;1;', '/4;3;/2;', 1469872367, 125, 1),
(19, 24, 64, 0, 35, 37, 2, 3, '/4/2/2', '/3/3/1', 4, 3, '/3;1;1;/6;4;/5;1;', '/4;4;/4;2;/1;', 1469872452, 126, 1),
(20, 24, 269, 0, 43, 44, 4, 1, '/4/2/1', '/3/3/2', 4, 3, '/4;4;2;/6;1;/1;', '/6;4;/5;5;/5;2;', 1469872513, 127, 0),
(21, 24, 269, 0, 43, 44, 0, 1, '/6', '/1', 6, 1, '/3;2;1;', '/2;', 1469872525, 127, 1),
(22, 24, 269, 0, 44, 45, 2, 3, '/5/4/3', '/3/2/1', 5, 3, '/5;2;1;/5;3;3;/3;3;2;', '/4;3;/4;4;/1;', 1469872533, 127, 1),
(23, 24, 64, 0, 37, 34, 3, 3, '/8/7/5', '/3/2/2', 8, 3, '/6;5;2;/2;2;1;/5;4;2;', '/6;1;/5;5;/4;1;', 1469872556, 128, 1),
(24, 24, 64, 0, 34, 33, 0, 4, '/4/4', '/4/2', 4, 4, '/3;3;1;/5;4;1;', '/2;1;/4;1;', 1469872570, 128, 1),
(25, 24, 64, 0, 33, 38, 1, 3, '/3/2', '/3/2', 3, 3, '/6;1;1;/6;5;', '/1;1;/4;1;', 1469872584, 128, 1),
(26, 24, 269, 0, 45, 46, 1, 3, '/10/9', '/3/2', 10, 3, '/5;5;1;/6;4;2;', '/6;4;/3;1;', 1469872675, 129, 1),
(27, 24, 269, 0, 46, 47, 0, 3, '/8/8', '/3/1', 8, 3, '/6;6;5;/5;3;3;', '/4;2;/3;', 1469872681, 129, 1),
(28, 24, 269, 0, 47, 29, 3, 3, '/7/6/5/4', '/3/2/1/1', 7, 3, '/5;4;1;/6;1;1;/5;5;4;/6;6;6;', '/5;2;/5;2;/6;/4;', 1469872687, 129, 1),
(29, 24, 269, 0, 29, 31, 3, 1, '/3/2', '/3/2', 3, 3, '/5;5;4;/4;3;', '/5;1;/6;4;', 1469872693, 129, 0),
(30, 24, 64, 0, 38, 36, 2, 3, '/11/10/9', '/3/2/1', 11, 3, '/5;2;1;/6;2;1;/5;4;1;', '/3;2;/6;1;/1;', 1469872713, 130, 1),
(31, 24, 64, 0, 14, 5, 5, 4, '/8/7/5/3/3', '/4/3/3/3/1', 8, 4, '/3;1;1;/3;2;1;/1;1;1;/3;2;1;/6;3;2;', '/1;1;/6;5;/5;3;/2;1;/2;', 1469872782, 130, 1),
(32, 24, 269, 0, 29, 31, 0, 1, '/11', '/1', 11, 1, '/6;3;1;', '/2;', 1469872831, 131, 1),
(33, 24, 269, 0, 31, 30, 4, 3, '/10/8/7/6', '/3/3/2/1', 10, 3, '/4;1;1;/4;3;2;/4;3;2;/6;3;1;', '/4;2;/3;3;/4;1;/1;', 1469872835, 131, 1),
(34, 24, 269, 0, 30, 32, 1, 3, '/5/5/4', '/3/1/1', 5, 3, '/5;5;1;/6;4;2;/2;1;1;', '/2;2;/6;/1;', 1469872847, 131, 1),
(35, 24, 269, 0, 32, 22, 3, 1, '/3/2', '/3/2', 3, 3, '/6;4;2;/3;3;', '/6;1;/6;5;', 1469872856, 131, 0),
(36, 24, 64, 0, 5, 7, 0, 3, '/14/14', '/3/1', 14, 3, '/6;5;1;/5;5;2;', '/2;1;/4;', 1469872885, 132, 1),
(37, 24, 64, 0, 7, 3, 3, 4, '/13/13/11/10', '/4/2/2/1', 13, 4, '/5;4;1;/5;5;1;/6;3;2;/6;4;2;', '/3;2;/6;5;/6;1;/4;', 1469872898, 132, 1),
(38, 24, 64, 0, 3, 1, 3, 3, '/9/7/6', '/3/3/2', 9, 3, '/6;3;1;/4;4;3;/6;2;1;', '/6;3;/4;2;/4;1;', 1469872911, 132, 1),
(39, 24, 64, 0, 1, 4, 4, 3, '/5/4/2/1', '/3/2/2/1', 5, 3, '/5;4;2;/6;3;2;/6;1;/6;', '/5;2;/6;3;/4;1;/3;', 1469872919, 132, 1),
(40, 24, 269, 0, 32, 22, 0, 1, '/14', '/1', 14, 1, '/5;1;1;', '/1;', 1469872947, 133, 1),
(41, 24, 269, 0, 22, 28, 3, 4, '/13/12/10/10', '/4/3/3/1', 13, 4, '/4;4;4;/3;3;3;/6;3;1;/5;3;2;', '/4;1;/5;4;/3;1;/4;', 1469872952, 133, 1),
(42, 24, 269, 0, 28, 23, 2, 3, '/9/8/7', '/3/2/1', 9, 3, '/4;2;1;/5;3;3;/6;5;1;', '/3;2;/4;3;/3;', 1469872969, 133, 1),
(43, 24, 269, 0, 23, 26, 0, 4, '/6/6', '/4/2', 6, 4, '/6;5;3;/6;3;1;', '/5;3;/3;2;', 1469872974, 133, 1),
(44, 24, 269, 0, 26, 21, 1, 3, '/5/4', '/3/2', 5, 3, '/6;3;2;/6;5;1;', '/6;1;/5;4;', 1469872979, 133, 1),
(45, 24, 269, 0, 21, 25, 0, 3, '/3/3', '/3/1', 3, 3, '/5;3;2;/5;4;1;', '/1;1;/2;', 1469872986, 133, 1),
(46, 24, 64, 0, 4, 6, 4, 4, '/16/14/13/13/12', '/4/4/3/1/1', 16, 4, '/5;3;1;/5;2;1;/6;5;5;/2;1;1;/3;2;1;', '/5;5;/4;3;/3;2;/2;/2;', 1469873012, 134, 1),
(47, 24, 64, 0, 6, 18, 3, 4, '/11/9/8/8', '/4/4/3/1', 11, 4, '/4;3;1;/6;3;2;/4;3;3;/6;1;1;', '/6;5;/6;1;/2;1;/4;', 1469873022, 134, 1),
(48, 24, 64, 0, 18, 8, 3, 4, '/7/7/5/4', '/4/2/2/1', 7, 4, '/5;4;2;/4;3;1;/5;3;1;/6;3;1;', '/4;2;/4;3;/5;2;/5;', 1469873033, 134, 1),
(49, 24, 269, 0, 25, 20, 4, 3, '/22/20/19/18', '/3/3/2/1', 22, 3, '/5;3;3;/5;2;1;/5;4;3;/6;4;3;', '/6;6;/4;4;/6;3;/5;', 1469873071, 135, 1),
(50, 24, 269, 0, 20, 13, 1, 3, '/17/16', '/3/2', 17, 3, '/5;3;2;/5;4;2;', '/5;2;/3;1;', 1469873077, 135, 1),
(51, 24, 269, 0, 13, 15, 0, 4, '/15/15', '/4/2', 15, 4, '/6;6;2;/6;5;4;', '/4;4;/5;2;', 1469873090, 135, 1),
(52, 24, 269, 0, 15, 12, 0, 3, '/14/14', '/3/1', 14, 3, '/5;2;1;/4;4;3;', '/4;1;/1;', 1469873096, 135, 1),
(53, 24, 269, 0, 13, 19, 6, 4, '/13/13/11/9/8/7', '/4/2/2/2/1/1', 13, 4, '/6;5;3;/5;2;1;/5;1;1;/5;2;1;/5;4;1;/6;4;3;', '/5;2;/5;3;/6;5;/2;2;/5;/4;', 1469873113, 135, 1),
(54, 24, 269, 0, 19, 11, 6, 2, '/6/6/4/2', '/4/2/2/2', 6, 4, '/5;4;3;/5;4;2;/6;4;3;/2;1;', '/3;1;/5;5;/6;5;/4;2;', 1469873118, 135, 0),
(55, 24, 64, 0, 18, 17, 2, 4, '/19/17/17', '/4/4/2', 19, 4, '/5;4;2;/5;3;3;/6;4;2;', '/6;5;/4;2;/3;2;', 1469873144, 136, 1),
(56, 24, 64, 0, 17, 11, 1, 2, '/16/15', '/2/1', 16, 2, '/2;2;1;/5;4;2;', '/4;1;/3;', 1469873152, 136, 1),
(57, 24, 269, 0, 26, 27, 4, 3, '/25/24/22/21', '/3/2/2/1', 25, 3, '/6;4;3;/6;2;2;/5;3;1;/4;2;2;', '/6;2;/6;5;/5;2;/1;', 1469873193, 137, 1),
(58, 24, 269, 0, 27, 24, 0, 3, '/20/20', '/3/1', 20, 3, '/6;4;1;/6;5;3;', '/5;1;/1;', 1469873197, 137, 1),
(59, 24, 269, 0, 24, 2, 1, 3, '/19/18', '/3/2', 19, 3, '/6;5;2;/6;6;2;', '/6;4;/2;1;', 1469873204, 137, 1),
(60, 25, 269, 0, 30, 32, 1, 3, '/5/4', '/3/2', 5, 3, '/5;1;1;/6;4;2;', '/4;2;/3;1;', 1469873356, 139, 1),
(61, 25, 64, 0, 42, 39, 5, 1, '/5/4/2', '/3/2/2', 5, 3, '/5;1;1;/6;3;2;/3;1;', '/2;1;/6;3;/6;2;', 1469873376, 140, 0),
(62, 25, 269, 0, 32, 31, 4, 3, '/6/5/3/2', '/3/2/2/1', 6, 3, '/3;3;2;/2;2;1;/6;2;2;/6;6;', '/5;2;/4;2;/4;2;/3;', 1469873447, 141, 1),
(63, 25, 64, 0, 42, 39, 0, 1, '/2', '/1', 2, 1, '/3;3;', '/1;', 1469873469, 142, 1),
(64, 25, 269, 0, 31, 29, 1, 3, '/5/5/4', '/3/1/1', 5, 3, '/6;5;3;/6;5;2;/6;2;1;', '/5;4;/6;/2;', 1469873499, 143, 1),
(65, 25, 64, 0, 39, 41, 0, 3, '/4/4', '/3/1', 4, 3, '/5;4;3;/5;3;1;', '/4;2;/3;', 1469873541, 144, 1),
(66, 25, 64, 0, 41, 40, 0, 3, '/3/3', '/3/1', 3, 3, '/6;4;1;/6;3;3;', '/5;2;/4;', 1469873551, 144, 1),
(67, 25, 269, 0, 29, 47, 3, 3, '/8/7/5', '/3/2/2', 8, 3, '/3;3;2;/3;1;1;/5;4;1;', '/6;1;/3;1;/4;3;', 1469873581, 145, 1),
(68, 25, 269, 0, 47, 46, 2, 3, '/4/2/2', '/3/3/1', 4, 3, '/4;2;1;/6;4;/5;3;', '/6;2;/5;1;/1;', 1469873587, 145, 1),
(69, 25, 64, 0, 40, 16, 0, 3, '/7/7', '/3/1', 7, 3, '/6;5;4;/6;1;1;', '/5;4;/3;', 1469873605, 146, 1),
(70, 25, 64, 0, 16, 9, 4, 3, '/6/4/3/2', '/3/3/2/1', 6, 3, '/6;4;3;/3;3;1;/4;4;4;/6;5;', '/6;5;/3;2;/6;1;/5;', 1469873616, 146, 1),
(71, 25, 269, 0, 46, 45, 4, 3, '/8/6/4/4', '/3/3/3/1', 8, 3, '/5;4;2;/6;5;1;/6;5;3;/6;5;5;', '/5;5;/6;5;/5;4;/4;', 1469873649, 147, 1),
(72, 25, 269, 0, 45, 44, 0, 3, '/3/3', '/3/1', 3, 3, '/5;4;1;/4;3;1;', '/2;1;/2;', 1469873657, 147, 1),
(73, 25, 64, 0, 9, 8, 4, 4, '/8/6/6/4', '/4/4/2/2', 8, 4, '/6;4;3;/6;5;4;/4;2;2;/6;5;1;', '/6;5;/4;4;/6;2;/4;1;', 1469873689, 148, 1),
(74, 25, 64, 0, 8, 14, 3, 2, '/3/2/1', '/3/2/1', 3, 3, '/6;3;1;/5;3;/1;', '/5;3;/5;2;/5;', 1469873703, 148, 0),
(75, 25, 269, 0, 44, 43, 1, 3, '/11/11/10', '/3/1/1', 11, 3, '/6;2;1;/5;4;3;/5;3;2;', '/2;1;/5;/4;', 1469873723, 149, 1),
(76, 25, 269, 64, 43, 42, 0, 1, '/9', '/1', 9, 1, '/6;6;2;', '/2;', 1469873731, 149, 1),
(77, 25, 64, 0, 8, 14, 0, 2, '/7', '/2', 7, 2, '/4;3;2;', '/1;1;', 1469873760, 150, 1),
(78, 25, 64, 0, 14, 10, 2, 3, '/6/5/4', '/3/2/1', 6, 3, '/6;5;3;/6;5;3;/5;2;1;', '/6;1;/6;3;/1;', 1469873767, 150, 1),
(79, 25, 269, 0, 45, 38, 2, 3, '/11/9/9', '/3/3/1', 11, 3, '/4;4;3;/6;4;2;/5;1;1;', '/5;4;/4;1;/1;', 1469873799, 151, 1),
(80, 25, 269, 0, 38, 36, 2, 3, '/8/7/6', '/3/2/1', 8, 3, '/4;2;1;/6;5;3;/6;5;2;', '/3;2;/6;1;/5;', 1469873806, 151, 1),
(81, 25, 269, 0, 36, 34, 4, 3, '/5/4/2/1', '/3/2/2/1', 5, 3, '/4;4;3;/3;3;2;/6;6;/5;', '/4;3;/5;3;/6;2;/3;', 1469873810, 151, 1),
(82, 25, 64, 0, 8, 18, 6, 4, '/9/7/7/5/3', '/4/4/2/2/2', 9, 4, '/6;4;1;/6;6;5;/6;2;2;/3;3;2;/6;2;2;', '/6;6;/2;1;/6;6;/6;4;/5;1;', 1469873847, 152, 1),
(83, 25, 269, 0, 34, 35, 2, 3, '/14/13/12', '/3/2/1', 14, 3, '/3;2;1;/5;3;1;/5;3;3;', '/2;2;/5;2;/4;', 1469873883, 153, 1),
(84, 25, 269, 0, 35, 5, 1, 4, '/11/10/10', '/4/3/1', 11, 4, '/4;4;1;/5;3;2;/5;4;1;', '/6;2;/4;2;/4;', 1469873889, 153, 1),
(85, 25, 269, 0, 5, 3, 5, 4, '/9/8/6/4/4', '/4/3/3/3/1', 9, 4, '/5;3;1;/6;5;3;/4;2;2;/6;5;1;/5;5;2;', '/5;1;/6;5;/5;3;/2;1;/4;', 1469873897, 153, 1),
(86, 25, 269, 0, 3, 4, 3, 2, '/3/3/2/1', '/3/1/1/1', 3, 3, '/6;4;3;/3;2;1;/3;1;/1;', '/5;2;/6;/6;/3;', 1469873903, 153, 0),
(87, 25, 64, 0, 18, 6, 2, 4, '/12/12/10', '/4/2/2', 12, 4, '/5;4;2;/4;3;1;/4;4;3;', '/4;1;/5;4;/2;1;', 1469873921, 154, 1),
(88, 25, 64, 269, 6, 3, 0, 1, '/9', '/1', 9, 1, '/5;4;1;', '/4;', 1469873933, 154, 1),
(89, 25, 64, 269, 3, 5, 0, 1, '/8', '/1', 8, 1, '/3;3;3;', '/1;', 1469873942, 154, 1),
(90, 25, 64, 269, 5, 35, 1, 1, '/7/6', '/1/1', 7, 1, '/6;3;1;/4;1;1;', '/6;/1;', 1469873949, 154, 1),
(91, 25, 64, 269, 35, 34, 1, 1, '/5/4', '/1/1', 5, 1, '/2;1;1;/6;3;1;', '/3;/4;', 1469873958, 154, 1),
(92, 25, 64, 269, 34, 38, 0, 1, '/3', '/1', 3, 1, '/6;5;4;', '/5;', 1469873965, 154, 1),
(93, 25, 64, 269, 38, 36, 0, 1, '/2', '/1', 2, 1, '/4;2;', '/3;', 1469873971, 154, 1),
(94, 25, 64, 0, 38, 33, 1, 4, '/17/16/16', '/4/3/1', 17, 4, '/6;4;3;/6;6;6;/6;2;2;', '/6;1;/3;1;/4;', 1469874035, 156, 1),
(95, 25, 64, 0, 33, 37, 2, 3, '/15/13/13', '/3/3/1', 15, 3, '/6;3;2;/6;4;1;/6;6;5;', '/6;5;/3;3;/2;', 1469874041, 156, 1),
(96, 25, 64, 0, 37, 7, 6, 3, '/12/10/8/6/6', '/3/3/3/3/1', 12, 3, '/4;3;2;/4;3;3;/3;2;2;/3;2;1;/6;5;3;', '/6;4;/5;5;/5;4;/1;1;/3;', 1469874047, 156, 1),
(97, 25, 64, 0, 7, 1, 5, 2, '/5/3/3/2/1', '/3/3/1/1/1', 5, 3, '/4;3;1;/6;5;3;/3;3;1;/3;1;/3;', '/6;3;/4;3;/3;/6;/5;', 1469874053, 156, 0),
(98, 25, 269, 64, 45, 38, 0, 1, '/17', '/1', 17, 1, '/3;2;1;', '/1;', 1469874085, 157, 1),
(99, 25, 64, 0, 7, 1, 2, 2, '/19/17', '/2/2', 19, 2, '/4;2;1;/4;3;3;', '/6;3;/3;2;', 1469874115, 158, 1),
(100, 25, 64, 0, 1, 2, 1, 3, '/16/16/15', '/3/1/1', 16, 3, '/6;5;4;/6;5;2;/5;5;1;', '/3;1;/6;/3;', 1469874127, 158, 1),
(101, 25, 64, 0, 2, 24, 3, 3, '/14/13/11', '/3/2/2', 14, 3, '/6;3;2;/3;3;2;/4;4;3;', '/5;3;/6;3;/3;1;', 1469874133, 158, 1),
(102, 25, 64, 0, 24, 27, 3, 3, '/10/8/8/7', '/3/3/1/1', 10, 3, '/5;2;1;/6;6;5;/4;3;1;/5;4;1;', '/6;3;/2;1;/5;/3;', 1469874141, 158, 1),
(103, 25, 64, 0, 27, 23, 0, 3, '/6/6', '/3/1', 6, 3, '/5;2;2;/2;2;2;', '/4;1;/1;', 1469874152, 158, 1),
(104, 25, 64, 0, 23, 22, 1, 3, '/5/5/4', '/3/1/1', 5, 3, '/6;4;3;/6;6;3;/6;3;3;', '/5;1;/6;/5;', 1469874165, 158, 1),
(105, 25, 269, 64, 38, 36, 8, 2, '/16/14/12/10/8', '/2/2/2/2/2', 16, 2, '/1;1;1;/2;1;1;/4;2;1;/4;3;3;/5;5;2;', '/5;5;/6;1;/5;3;/6;4;/3;2;', 1469874199, 159, 1),
(106, 25, 64, 0, 23, 28, 3, 4, '/24/22/22/21', '/4/4/2/1', 24, 4, '/4;2;1;/5;4;2;/4;3;3;/6;6;4;', '/6;5;/3;3;/6;1;/1;', 1469874250, 160, 1),
(107, 25, 64, 0, 28, 21, 1, 3, '/20/19', '/3/2', 20, 3, '/4;3;1;/6;6;1;', '/6;2;/5;5;', 1469874262, 160, 1),
(108, 25, 64, 0, 21, 26, 6, 4, '/18/18/16/14/12', '/4/2/2/2/2', 18, 4, '/6;4;3;/5;3;2;/5;2;1;/6;2;2;/6;6;5;', '/5;3;/5;4;/6;2;/6;6;/3;3;', 1469874275, 160, 1),
(109, 25, 64, 0, 26, 25, 3, 3, '/11/9/8', '/3/3/2', 11, 3, '/4;2;2;/5;2;1;/5;5;5;', '/5;2;/2;2;/1;1;', 1469874282, 160, 1),
(110, 25, 64, 0, 25, 20, 4, 3, '/7/5/4/3', '/3/3/2/1', 7, 3, '/2;2;1;/6;6;1;/5;5;1;/5;3;2;', '/4;4;/6;1;/5;4;/4;', 1469874291, 160, 1),
(111, 25, 269, 64, 42, 39, 0, 1, '/15', '/1', 15, 1, '/4;4;3;', '/3;', 1469874326, 161, 1),
(112, 25, 269, 64, 39, 41, 0, 1, '/14', '/1', 14, 1, '/6;6;5;', '/3;', 1469874330, 161, 1),
(113, 25, 269, 64, 41, 40, 0, 1, '/13', '/1', 13, 1, '/6;3;2;', '/1;', 1469874334, 161, 1),
(114, 25, 269, 64, 40, 16, 0, 1, '/12', '/1', 12, 1, '/6;5;1;', '/3;', 1469874340, 161, 1),
(115, 25, 269, 64, 38, 33, 0, 1, '/14', '/1', 14, 1, '/5;3;2;', '/3;', 1469874344, 161, 1),
(116, 25, 269, 64, 33, 34, 0, 1, '/13', '/1', 13, 1, '/5;5;2;', '/3;', 1469874351, 161, 1),
(117, 25, 269, 64, 34, 37, 0, 1, '/12', '/1', 12, 1, '/6;2;1;', '/1;', 1469874356, 161, 1),
(118, 25, 269, 64, 37, 35, 2, 1, '/11/10/9', '/1/1/1', 11, 1, '/4;4;1;/5;4;4;/5;4;2;', '/5;/6;/2;', 1469874360, 161, 1),
(119, 26, 269, 0, 73, 72, 0, 3, '/5/5', '/3/1', 5, 3, '/5;2;1;/5;4;2;', '/2;1;/3;', 1469875140, 164, 1),
(120, 26, 64, 0, 94, 93, 1, 3, '/8/7', '/3/2', 8, 3, '/3;3;1;/6;5;1;', '/4;2;/3;2;', 1469875179, 165, 1),
(121, 26, 64, 0, 93, 91, 5, 3, '/6/4/4/3/2/1', '/3/3/1/1/1/1', 6, 3, '/3;1;1;/4;4;3;/3;3;3;/6;6;2;/5;3;/5;', '/4;3;/3;2;/5;/6;/5;/2;', 1469875188, 165, 1),
(122, 26, 269, 0, 72, 66, 2, 3, '/4/3/2', '/3/2/1', 4, 3, '/6;5;4;/4;3;2;/6;5;', '/6;4;/5;2;/1;', 1469875209, 166, 1),
(123, 26, 269, 0, 66, 67, 4, 1, '/4/3/1', '/4/3/3', 4, 4, '/4;4;3;/4;3;3;/5;', '/4;3;/4;4;/5;2;', 1469875223, 166, 0),
(124, 26, 64, 0, 91, 92, 4, 3, '/4/3/2/1', '/4/3/2/1', 4, 4, '/4;4;4;/6;1;1;/4;4;/2;', '/5;1;/4;4;/6;2;/4;', 1469875243, 167, 0),
(125, 26, 269, 0, 66, 67, 4, 0, '/4/3/2/1', '/1/1/1/1', 4, 1, '/5;4;1;/5;1;1;/4;2;/2;', '/6;/6;/6;/4;', 1469875329, 168, 0),
(126, 26, 64, 0, 91, 92, 4, 0, '/4/2', '/3/3', 4, 3, '/5;3;1;/3;1;', '/5;4;/6;5;', 1469875352, 169, 0),
(127, 26, 269, 0, 67, 62, 2, 3, '/3/2/1', '/3/2/1', 3, 3, '/5;2;1;/5;4;/5;', '/3;3;/5;2;/1;', 1469875411, 170, 1),
(128, 26, 64, 0, 92, 90, 3, 1, '/3/2', '/3/2', 3, 3, '/6;1;1;/1;1;', '/3;2;/6;3;', 1469875466, 171, 0),
(129, 26, 269, 0, 62, 55, 0, 3, '/6/6', '/3/1', 6, 3, '/5;5;1;/6;5;1;', '/2;1;/1;', 1469875494, 172, 1),
(130, 26, 269, 0, 55, 56, 0, 3, '/5/5', '/3/1', 5, 3, '/6;6;2;/6;2;1;', '/4;3;/4;', 1469875502, 172, 1),
(131, 26, 64, 0, 92, 90, 1, 1, '/5/4', '/1/1', 5, 1, '/3;1;1;/5;5;4;', '/5;/3;', 1469875525, 173, 1),
(132, 26, 269, 0, 56, 52, 10, 4, '/12/10/9/8/6/4/2', '/4/4/3/2/2/2/2', 12, 4, '/5;4;1;/4;4;1;/6;4;1;/3;2;2;/2;2;1;/5;4;3;/6;2;', '/6;5;/5;1;/6;3;/5;3;/5;3;/5;4;/4;1;', 1469875605, 174, 1),
(133, 26, 64, 0, 91, 89, 0, 4, '/9/9', '/4/2', 9, 4, '/6;4;2;/5;5;5;', '/2;1;/3;2;', 1469875631, 175, 1),
(134, 26, 64, 0, 89, 87, 8, 1, '/8/7/5/3/1', '/4/3/3/3/3', 8, 4, '/4;3;3;/4;1;1;/5;4;1;/4;3;2;/4;', '/4;2;/5;1;/5;4;/5;5;/6;3;', 1469875640, 175, 0),
(135, 26, 269, 0, 52, 51, 4, 3, '/10/9/7/6', '/3/2/2/1', 10, 3, '/5;2;2;/5;4;2;/5;5;2;/4;3;2;', '/3;3;/6;5;/6;3;/2;', 1469875829, 176, 1),
(136, 26, 269, 0, 51, 50, 1, 4, '/5/4/4', '/4/3/1', 5, 4, '/5;3;2;/5;3;1;/4;1;1;', '/6;1;/2;1;/1;', 1469875836, 176, 1),
(137, 26, 64, 0, 89, 87, 1, 1, '/7/6', '/1/1', 7, 1, '/6;5;2;/5;3;1;', '/6;/3;', 1469875858, 177, 1),
(138, 26, 64, 0, 87, 88, 0, 3, '/5/5', '/3/1', 5, 3, '/6;4;1;/6;5;5;', '/5;1;/3;', 1469875865, 177, 1),
(139, 26, 64, 0, 87, 86, 0, 4, '/4/4', '/4/2', 4, 4, '/6;5;2;/6;6;4;', '/2;1;/3;3;', 1469875901, 177, 1),
(140, 26, 269, 0, 73, 76, 1, 3, '/11/10', '/3/2', 11, 3, '/6;4;2;/6;6;2;', '/6;1;/4;1;', 1469875941, 178, 1),
(141, 26, 269, 0, 76, 77, 0, 3, '/9/9', '/3/1', 9, 3, '/6;3;1;/5;2;2;', '/4;2;/1;', 1469875948, 178, 1),
(142, 26, 269, 0, 77, 71, 5, 4, '/8/6/5/3/3', '/4/4/3/3/1', 8, 4, '/4;2;1;/2;2;1;/5;5;1;/6;5;2;/6;6;5;', '/6;2;/4;1;/6;5;/5;3;/1;', 1469875952, 178, 1),
(143, 26, 269, 0, 71, 70, 2, 0, '/2', '/3', 2, 3, '/4;3;', '/5;4;', 1469875957, 178, 0),
(144, 26, 64, 0, 86, 84, 1, 3, '/13/12', '/3/2', 13, 3, '/5;3;2;/5;2;2;', '/6;2;/4;1;', 1469875981, 179, 1),
(145, 26, 64, 0, 84, 85, 2, 3, '/11/10/9', '/3/2/1', 11, 3, '/5;3;1;/5;3;3;/5;4;1;', '/5;1;/6;1;/4;', 1469875989, 179, 1),
(146, 26, 64, 0, 85, 81, 5, 4, '/8/7/5/3/3', '/4/3/3/3/1', 8, 4, '/6;5;2;/3;1;1;/4;1;1;/5;5;1;/6;6;3;', '/6;1;/4;1;/5;5;/2;2;/5;', 1469875995, 179, 1),
(147, 26, 64, 0, 81, 75, 6, 4, '/15/13/11/10/10/9', '/4/4/4/3/1/1', 15, 4, '/6;2;1;/4;3;2;/6;4;3;/5;3;3;/2;2;2;/5;4;4;', '/6;2;/5;3;/5;4;/2;2;/6;/2;', 1469876047, 181, 1),
(148, 26, 64, 0, 75, 74, 4, 3, '/8/6/6/5/4', '/3/3/1/1/1', 8, 3, '/6;5;4;/6;5;1;/5;2;2;/4;3;2;/4;2;1;', '/6;6;/4;1;/6;/4;/1;', 1469876053, 181, 1),
(149, 26, 64, 0, 84, 83, 2, 3, '/18/17/16', '/3/2/1', 18, 3, '/6;1;1;/5;5;1;/5;3;2;', '/3;1;/6;1;/3;', 1469876264, 183, 1),
(150, 26, 64, 0, 83, 82, 0, 4, '/15/15', '/4/2', 15, 4, '/6;5;1;/6;4;2;', '/3;2;/4;3;', 1469876271, 183, 1),
(151, 26, 64, 0, 82, 80, 2, 3, '/14/12/12', '/3/3/1', 14, 3, '/3;2;1;/6;5;4;/6;3;1;', '/5;2;/5;3;/1;', 1469876277, 183, 1),
(152, 26, 64, 0, 80, 79, 0, 3, '/11/11', '/3/1', 11, 3, '/5;5;2;/6;5;3;', '/3;2;/4;', 1469876284, 183, 1),
(153, 26, 64, 0, 79, 78, 10, 0, '/10/8/6/4/2', '/4/4/4/4/4', 10, 4, '/4;3;1;/2;2;1;/5;4;1;/4;3;1;/1;1;', '/6;3;/5;2;/5;5;/4;3;/6;1;', 1469876303, 183, 0),
(154, 26, 64, 0, 79, 95, 0, 3, '/19/19', '/3/1', 19, 3, '/6;5;4;/5;4;1;', '/4;2;/3;', 1469876441, 185, 1);
...
--
-- Vider la table avant d'insérer `frontier`
--
...
--
-- Vider la table avant d'insérer `game`
--
...
--
-- Vider la table avant d'insérer `game_data`
--
...
--
-- Vider la table avant d'insérer `game_player`
--
...
(44, 1, 1, 1, 26, 269, 8, 1469874431, 1, 0, 0),
(45, 1, 1, 1, 26, 64, 9, 1469874436, 2, 0, 0);
...
--
-- Vider la table avant d'insérer `harbor`
--

TRUNCATE TABLE `harbor`;
--
...
--
-- Vider la table avant d'insérer `land`
--
...
--
-- Vider la table avant d'insérer `message_read`
--
...
--
-- Vider la table avant d'insérer `mod`
--
...
--
-- Vider la table avant d'insérer `move`
--
...
--
-- Vider la table avant d'insérer `pact`
--
...
--
-- Vider la table avant d'insérer `pact_list`
--

TRUNCATE TABLE `pact_list`;
--
...
--
-- Vider la table avant d'insérer `resource`
--
...
--
-- Vider la table avant d'insérer `turn`
--
...
--
-- Vider la table avant d'insérer `version`
--
