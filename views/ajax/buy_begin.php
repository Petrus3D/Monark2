...
<div class="buy-view-ajax">
	...
	<?php if($userTurn): ?>
		<?php if($CurrentTurnData->getTurnGold() > 0): ?>
			<table>
				<tr>
					<td id='td-show-units-def' style="padding: 4px;"><font size='4'><?= Yii::t('ajax', 'Text_Units'); ?> <?= $Land[$land_id]->getLandName() ?> : </font><font size='4'><?= $GameData[$land_id]->getGameDataUnits()." ".Yii::t('ajax', 'Text_Buy_Units_Pending')?></font></td>
				</tr>
				<tr>
