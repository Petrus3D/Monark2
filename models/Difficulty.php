 ...
 * @property integer $difficulty_rate_ressources
...
class Difficulty extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['difficulty_name', 'difficulty_rate_bot_units', 'difficulty_rate_ressources', 'difficulty_rate_oper', 'difficulty_rate_units_atk', 'difficulty_rate_units_def', 'difficulty_rate_atk_frt', 'difficulty_rate_def_pc', 'difficulty_rate_exec_atk', 'difficulty_rate_exec_def', 'difficulty_rate_exec_build', 'difficulty_marge_frt', 'difficulty_marge_pc', 'difficulty_build_mine'], 'required'],
            [['difficulty_rate_bot_units', 'difficulty_rate_ressources', 'difficulty_rate_units_atk', 'difficulty_rate_units_def', 'difficulty_rate_atk_frt', 'difficulty_rate_def_pc', 'difficulty_rate_exec_atk', 'difficulty_rate_exec_def', 'difficulty_rate_exec_build', 'difficulty_marge_frt', 'difficulty_marge_pc', 'difficulty_build_mine'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'difficulty_rate_ressources' => 'Difficulty Rate Ressources',
